<template>
  <main class="min-h-screen bg-[#FAF7F2] text-stone-900">
    ...
    <section
      ...
      :style="{ backgroundImage: `url(${classesBgImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }"
    >
      ...
      <div class="relative mx-auto max-w-3xl z-10">
        <div class="text-center">
          ...
          <h1 class="text-5xl font-bold leading-tight tracking-tight md:text-7xl">Find your perfect flow</h1>

          <p class="mt-6 mx-auto max-w-xl text-xl font-semibold leading-8 text-stone-900 drop-shadow-sm">
    ...
    <section class="mx-auto max-w-7xl px-6 pb-20">
      ...
      <div class="mb-10 text-center">
        ...
        <h3 class="mt-4 text-3xl font-bold tracking-tight text-stone-800 md:text-4xl">Get To Know Your Level</h3>
      </div>

      <section class="relative px-2 py-8">
        <div class="pointer-events-none absolute left-[16%] right-[16%] top-16 hidden border-t-2 border-dashed border-stone-400/70 md:block"></div>
      ...
      <div class="mb-10 grid gap-4 md:grid-cols-2">
        ...
        <div class="flex flex-wrap gap-3">
          <button
            @click="selectedLevel = ''"
            :class="selectedLevel === '' ? 'rounded-full bg-stone-900 px-5 py-2 text-white' : 'rounded-full border px-5 py-2'"
          >
            All
          </button>
          ...
          <button
            ...
            :class="selectedLevel === 'Beginner' ? 'rounded-full bg-stone-900 px-5 py-2 text-white' : 'rounded-full border px-5 py-2'"
          >
            Beginner
          </button>
          ...
          <button
            ...
            :class="selectedLevel === 'Intermediate' ? 'rounded-full bg-stone-900 px-5 py-2 text-white' : 'rounded-full border px-5 py-2'"
          >
            Intermediate
          </button>
          ...
          <button
            ...
            :class="selectedLevel === 'Advanced' ? 'rounded-full bg-stone-900 px-5 py-2 text-white' : 'rounded-full border px-5 py-2'"
          >
            Advanced
          </button>
        </div>
      ...
      <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <div class="mb-5 flex h-52 items-center justify-center rounded-[1.5rem] bg-gradient-to-br from-[#F5EFE6] to-[#D9C5B2]/40">
...
const classes = ref([
  {
    ...
    slots: 4,
    icon: '🌿',
    description: 'A calm beginner-friendly session focused on breathing, posture, and slow movement.',
  },
  {
    id: 2,
    name: 'Core Sculpt',
    ...
    slots: 2,
    icon: '🔥',
    description: 'A powerful class designed to strengthen your core and improve body control.',
  },
  {
    id: 3,
    name: 'Flex & Restore',
    ...
    slots: 8,
    icon: '🧘🏻‍♀️',
    description: 'A restorative Pilates class focusing on flexibility, mobility, and stress relief.',
  },
  {
    id: 4,
    name: 'Power Reformer',
    ...
    slots: 3,
    icon: '✨',
    description: 'An advanced full-body Pilates session for strength, balance, and endurance.',
  },
  {
    id: 5,
    name: 'Morning Glow',
    ...
    slots: 10,
    icon: '☀️',
    description: 'A refreshing morning class to energise your body and prepare your mind.',
  },
  {
    id: 6,
    name: 'Tone & Balance',
    ...
    slots: 6,
    icon: '🤍',
    description: 'A balanced workout combining toning movements with posture improvement.',
  },
])
